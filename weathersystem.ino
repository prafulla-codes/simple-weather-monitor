...
String AP = "pika network";       // put your wifi name here
String PASS = "pika12345"; // put your wifi password here
String API = "S62PS9XKR6RF8XU1";   // put the API key from things speak , "Write API KEY"
...
float Po = 1013.0;
float valAirQuality = 1; // create 3 variables to get your field value from sensors , initialize them some random number initially
float valTemperature = 1;
float valHumidity = 1;
double valPressure = 1;
double valAltitude = 1;
...
void loop() {
 ...
 valHumidity = getHumidity(); // same as above
...
void sendCommand(String command, int maxTime, char readReplay[]) {  // keep as it is
  ...
  if(found == true)
  {
    Serial.println("OYI");  // keep as it is
